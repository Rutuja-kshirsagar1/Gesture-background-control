...
audio1 = "fire.mpeg"
audio2 = "sharengan audio.mp3"
audio3 = "galaxy audio.mp3"
...
# -----------------------------
bg_video1 = cv2.VideoCapture("ultra.mp4")
bg_video2 = cv2.VideoCapture("sharengan.mp4")
bg_video3 = cv2.VideoCapture("galaxy.mp4")
